...
const rule = require("../../../lib/rules/computed-property-even-spacing")
...
tester.run("computed-property-even-spacing", rule, {
    valid: [
        // even
    ...
    invalid: [
        // even
        {
            code: "bar[  'foo'  ]",
            options: ["even"],
            errors: [{ message: 'Expected 1 or 0 spaces around "[" and "]".' }],
        },
        {
            code: "bar['foo' ]",
            options: ["even"],
        ...
        },
        {
            ...
            options: ["even"],
            errors: [
                { message: 'Expected "[" and "]" to be on the same line.' },
            ],
        },
        {
            code: "bar[\n\t'foo' ]",
