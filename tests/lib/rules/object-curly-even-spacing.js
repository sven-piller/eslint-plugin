...
const rule = require("../../../lib/rules/object-curly-even-spacing")
...
tester.run("object-curly-even-spacing.", rule, {
    valid: [
        // either
        ...
        {
            code:
                "var obj = { 'qux': [ 1, 2 ], 'foo': { 'bar': 1, 'baz': 2 }};",
            options: [
                "always",
        ...
        {
            code:
                "var obj = { 'foo': { 'bar': 1, 'baz': 2 }, 'qux': [ 1, 2 ]};",
            options: [
                "always",
                { arraysInObjects: false, objectsInObjects: false },
            ],
        ...
        { code: "export {door}", options: ["never"], parserOptions },
        {
            code: "import 'room'",
            options: ["never"],
            parserOptions,
