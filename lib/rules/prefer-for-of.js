...
function isTraversingArray(node) {
    ...
    /*eslint-disable @svenpiller/prettier */
    return (
        init != null &&
    ...
    /*eslint-enable @svenpiller/prettier */
}
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: false,
            url:
                "https://github.com/sven-piller/eslint-plugin/blob/v0.1.0-0/docs/rules/prefer-for-of.md",
        },
        fixable: "code",
        schema: [],
    },
