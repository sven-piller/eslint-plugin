...
const FUNC_TYPE = /^(?:FunctionDeclaration|(?:New|Call|(?:Arrow)?Function)Expression)$/
const PROPERTY_PATTERN = /^(?:Experimental)?(Rest|Spread)Property$/
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: false,
            url:
                "https://github.com/sven-piller/eslint-plugin/blob/v0.1.0-0/docs/rules/no-useless-rest-spread.md",
        },
        fixable: "code",
        schema: [],
    },
