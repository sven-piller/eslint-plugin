...
const LITERAL_TYPE = /^(?:(?:Array|Object)Expression|(?:Template)?Literal)$/
const LITERAL_AND_CLASS_TYPE = /^(?:(?:Array|Class|Object)Expression|(?:Template)?Literal)$/
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: false,
            url:
                "https://github.com/sven-piller/eslint-plugin/blob/v0.1.0-0/docs/rules/no-literal-call.md",
        },
        fixable: null,
        schema: [],
    },
